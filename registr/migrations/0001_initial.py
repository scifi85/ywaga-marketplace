...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('registr_registrationprofile', (
            ...
            ('msn', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('post', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ...
        db.send_create_signal('registr', ['RegistrationProfile'])

    def backwards(self, orm):
        
        # Deleting model 'RegistrationProfile'
        db.delete_table('registr_registrationprofile')
    ...
    models = {
        ...
        'registr.registrationprofile': {
            ...
            'post': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
