...
window.webcam = {
	...
	swf_url: '/static/plugins/cam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: '/static/plugins/cam/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : '/static/plugins/cam/shutter.mp3';
	},
